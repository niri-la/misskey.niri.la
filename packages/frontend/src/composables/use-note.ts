...
export function checkBuiltinSoftMute(
	...
	collapseSensitiveChannel: boolean,
): 'sensitiveChannel' | 'sensitiveMute' | false {
...
export function useNote(
	...
	const muted = ref($i ? checkNoteWordMute(appearNote, $i, $i.mutedWords) || checkBuiltinSoftMute(appearNote, inTimeline && !tl_withSensitive.value, collapseSensitiveChannel) : false);
